      ...
      <div class="p-8 md:p-12 bg-white">
          ...
          <div v-if="step === 1" key="step1" class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="space-y-2">
                ...
                <input v-model="form.placas" placeholder="ABC-123" class="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 font-black text-slate-700 focus:ring-2 focus:ring-primario/20 outline-none uppercase" />
              </div>
              <div class="space-y-2">
                <label class="text-[10px] font-black text-slate-400 uppercase ml-2">VIN (Número de Serie) *</label>
                <input v-model="form.num_serie" class="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 font-black text-slate-700 focus:ring-2 focus:ring-primario/20 outline-none uppercase" />
              </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div class="space-y-2">
                ...
                <input v-model="form.marca" class="w-full bg-slate-50 border-none rounded-2xl px-6 py-3 font-bold uppercase" />
              </div>
              <div class="space-y-2">
              ...
              <div class="space-y-2">
                ...
                <input v-model="form.modelo" class="w-full bg-slate-50 border-none rounded-2xl px-6 py-3 font-bold uppercase" />
              </div>
              <div class="space-y-2">
                <label class="text-[10px] font-black text-slate-400 uppercase ml-2">Año *</label>
                <input v-model.number="form.anio" type="number" class="w-full bg-slate-50 border-none rounded-2xl px-6 py-3 font-bold" />
              </div>
              <div class="space-y-2">
                <label class="text-[10px] font-black text-slate-400 uppercase ml-2">Color Original</label>
                <input v-model="form.color_original" class="w-full bg-slate-50 border-none rounded-2xl px-6 py-3 font-bold" />
              </div>
              <div class="space-y-2">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div class="space-y-2">
                ...
                <input v-model="form.numero_motor" class="w-full bg-slate-50 border-none rounded-2xl px-6 py-3 font-bold uppercase" />
              </div>
              <div class="space-y-2">
                <label class="text-[10px] font-black text-slate-400 uppercase ml-2">Tipo de Vehículo *</label>
                <input v-model="form.tipo_vehiculo" placeholder="Ej. Sedán, SUV, Motocicleta" class="w-full bg-slate-50 border-none rounded-2xl px-6 py-3 font-bold uppercase" />
              </div>
          ...
          <div v-else-if="step === 2" key="step2" class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div class="space-y-2">
                ...
                <input v-model="form.autoridad_ingreso" class="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 font-bold" />
              </div>
              <div class="space-y-2" v-if="form.tipo_registro === 'INVENTARIO'">
            ...
            <div class="space-y-2">
              ...
              <input v-model="form.lugar_siniestro" class="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 font-bold" />
            </div>
            <div class="space-y-2">
              <label class="text-[10px] font-black text-slate-400 uppercase ml-2">Motivo de Ingreso *</label>
              <input v-model="form.motivo_ingreso" class="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 font-bold" />
            </div>
              ...
              <div class="border-t border-slate-100 pt-8 mt-8 space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div class="space-y-2">
                    ...
                    <input v-model="form.condicion_juridica" type="text" class="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 font-black text-slate-700">
                  
                  </div>

                  <div class="space-y-2">
                    <label class="text-[10px] font-black text-slate-400 uppercase ml-2">Número de Oficio *</label>
                    <input v-model="form.num_oficio" placeholder="Ej. PGR/TLX/123/2026" class="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 font-black uppercase outline-none focus:ring-2 focus:ring-primario/20" />
                  </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div class="space-y-2">
                    ...
                    <input v-model="form.fecha_oficio" type="date" class="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 font-black" />
                  </div>
        ...
        <div class="flex justify-between items-center mt-12 pt-8 border-t border-slate-100">
          ...
          <div class="flex gap-4">
            ...
            <button v-if="step < 4" @click="step++" class="bg-primario text-white px-10 py-4 rounded-2xl font-black text-[10px] uppercase tracking-widest shadow-xl shadow-primario/20">Siguiente Paso</button>
...
Object.entries(form.value).forEach(([key, valor]) => {
  ...
  router.push('/inventario')
    ...
    alert(`❌ Error: ${error.response?.data?.detail || 'Verifica los campos'}`)
  } finally {
    loading.value = false
  }
}
